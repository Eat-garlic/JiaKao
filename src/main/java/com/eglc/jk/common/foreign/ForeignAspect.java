package com.eglc.jk.common.foreign;
...
import com.eglc.jk.common.foreign.anno.ForeignField.ForeignFields;
import com.eglc.jk.common.foreign.info.ForeignFieldInfo;
import com.eglc.jk.common.foreign.info.ForeignTableInfo;
import com.eglc.jk.common.util.Classes;
import com.eglc.jk.common.util.JsonVos;
import com.eglc.jk.common.util.Strings;
...
public class ForeignAspect implements InitializingBean {
    private static final String FOREIGN_SCAN = "classpath*:com/eglc/jk/pojo/po/**/*.class";
    @Autowired
    private ApplicationContext ctx;
    @Autowired
    private ResourceLoader resourceLoader;

    @Around("execution(* com.eglc.jk.service..*.remove*(..))")
    ...
    @Around("execution(* com.eglc.jk.service..*.save*(..)) || execution(* com.eglc.jk.service..*.update*(..)) ")
    ...
    private void parseCls(String clsName) throws Exception {
        ...
        Classes.enumerateFields(subCls, (subField, curCls) -> {
            ...
            ForeignField.ForeignFields ffs = subField.getAnnotation(ForeignFields.class);
